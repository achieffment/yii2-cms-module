...
//            'startDate' => date('d-m-Y H:i'),
    ...
    <?= $form->field($model, 'preview_image_file')->widget(FileInput::classname(), [
        ...
        'pluginEvents' => [
            "fileclear" => "function() { document.querySelector('#page-preview_image_hidden').value = ''; }",
            "filereset" => "function() { document.querySelector('#page-preview_image_hidden').value = ''; }",
        ]
    ]); ?>
    ...
    <?= $form->field($model, 'detail_image_file')->widget(FileInput::classname(), [
        ...
        'pluginEvents' => [
            "fileclear" => "function() { document.querySelector('#page-detail_image_hidden').value = ''; }",
            "filereset" => "function() { document.querySelector('#page-detail_image_hidden').value = ''; }",
        ]
    ]); ?>
